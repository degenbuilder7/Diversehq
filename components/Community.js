    ...
    return(
        <div className="bg-lightblack text-white">
            <div className="lg:flex lg:flex-row md:flex sm:flex sm:flex-col  justify-center items-center pt-32 items-center">
                <img className="rounded-[25px]" src="https://academy-public.coinmarketcap.com/optimized-uploads/1c07f13ce8e748f6934a28583cca6f5b.jpg" width={500} height={600}  />
                       ...
                       {community.map((item, index) =>{
                            return( 
                                      <div className="items-center py-5" key={index}>
                                        ...
                                        <img src={item.icon} width={60} height={60} className='p-2'/>
                                        </div>
